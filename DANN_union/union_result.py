...
# 文件夹路径
folder1_path = '/data/liyifan/Peptide_recomendation/单个序列input'
...
os.system(f'/data/liyifan/anaconda3/envs/pyto/bin/python /data/liyifan/Peptide_recomendation/串联推荐_生成片段推荐结果.py {rec_rate} 5 f n ')
os.system(f'/data/liyifan/anaconda3/envs/pyto/bin/python /data/liyifan/Peptide_recomendation/串联推荐_单个序列大模型.py {rec_rate} 5 f ')
